...
int main(){
   ...
   //Optimal ->Prefix Sum. TC->O(n)(Worst Case O(N^2) i.e if there are maximum collisions) SC->O(n)
   ...
   for(int i=0;i<n;i++){
    ...
    //Can't use sliding window here because of negative numbers. Can't shift the left pointer when we get sum = k
    cout<<max_count<<endl;
